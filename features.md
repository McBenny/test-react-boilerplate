...
- [X] Limit the number of yellow cards to 3 per team (allow for a fourth for officials)
...
- [X] It seems I can't add 16 players but only 15 (when unknown player has been added?)
